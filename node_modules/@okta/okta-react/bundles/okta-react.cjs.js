...
var Security = function Security(_ref) {
  ...
  React__namespace.useEffect(function () {
    ...
    if (oktaAuth._oktaUserAgent) {
      oktaAuth._oktaUserAgent.addEnvironment("@okta/okta-react".concat("/", "6.4.1"));
    } else {
  ...
  if (!oktaAuth._oktaUserAgent) {
    ...
    var isAuthJsSupported = process.env.SKIP_VERSION_CHECK === '1' || compareVersions.compare(oktaAuth._oktaUserAgent.getVersion(), {
